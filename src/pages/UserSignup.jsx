      ...
      <div className="login-wrapper">
        <div className="login-hero">
          ...
          <p className="hero-description">
            {step === 1
              ? "Let's start with your basic information. We'll need your name and contact details."
              : 'Almost there! Set up your email and password to complete your registration.'}
          </p>
        </div>
